...
public:
    ...
    PBA_EXPORT virtual void SetPointData(size_t npoint, PBAPoint3* pts);			//set 3D point data
    PBA_EXPORT virtual void SetProjection(size_t nproj, 
        const PBAPoint2f* imgpts,  const int* point_idx, const int* cam_idx);		//set projections
